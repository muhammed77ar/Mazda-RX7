...
export const LampContainer = ({
    ...
    return (
        (<div
            ...
            <div
                className="relative flex w-full flex-1 scale-y-170 items-center justify-center isolate z-0 ">
                <motion.div
                ...
                <motion.div
                    ...
                    className="absolute inset-auto z-30 h-36 w-64 -translate-y-[8rem] rounded-full bg-amber-400 blur-2xl"></motion.div>
                <motion.div
                    initial={{ width: "15rem" }}
